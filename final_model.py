...
class stock_summary_data():
    ...
    def __init__(self):
        self.stocks_files = glob.glob("/Users/wasaequreshi/Desktop/Cmpe257_StockAnalysis/Datasets/price-volume-data-for-all-us-stocks-etfs/Stocks/*.txt")
    ...
    def run(self):
        ...
        for file_path in self.stocks_files:
            try:
                ...
                final_data.append([stock_name, avg_yearly_return, variance_sum]) 
        ...
        for stock_data in final_data:
            try:
                ...
                file_write_csv.write(sector + "," + str(stock_data[0]) + "," + str(stock_data[1]) + "," + str(stock_data[2]) + "\n")
            except:
                print (stock_data)
