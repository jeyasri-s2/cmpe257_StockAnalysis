...
def parse_articles(articles):
    ...
    for i in articles['response']['docs']:
        ...
        if i['abstract'] is None:
            dic['abstract'] = ''
        dic['headline'] = '' # main attribute missing
...
path = r'C:/Users/subar/Downloads/GitHub/cmpe257_ml/Cmpe257_StockAnalysis/Datasets/financial-news-json/news-json/main/*.json'
