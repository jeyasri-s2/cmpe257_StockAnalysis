...
def parse_articles(articles):
    ...
    for i in articles['response']['docs']:
        dic = {}
        dic['id'] = i['_id']
        dic['abstract'] = '' # abstract missing
        dic['headline'] = i['headline']['main'].encode("utf8")
        dic['desk'] = '' #news_desk missing
        dic['date'] = i['pub_date'][0:10] # cutting time of day.
        dic['section'] = '' #section_name missing
...
path = r'C:/Users/subar/Downloads/GitHub/cmpe257_ml/Cmpe257_StockAnalysis/Datasets/financial-news-json/news-json/news_desk/*.json'
